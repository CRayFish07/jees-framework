...
public class ValidateUtil {
	...
	public static Integer filterInteger(String object, Integer min, Integer max) {
	...
	public static Double filterDouble(String object, Double min, Double max) {
	...
	public static Float filterFloat(String object, Float min, Float max) {
