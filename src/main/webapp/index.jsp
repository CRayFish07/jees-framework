...
<a href="<%=location%>/index/index/modelU" target="_blank">数据库操作示例 - 修改</a><br/>
<a href="<%=location%>/index/index/modelR" target="_blank">数据库操作示例 - 读取</a><br/>
<a href="<%=location%>/index/index/modelD" target="_blank">数据库操作示例 - 删除</a><br/>
</body>
</html>